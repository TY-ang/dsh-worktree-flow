...
import { registerSharedDocsTools } from "./shared-docs-tools.js";
...
function apply(ctx) {
	...
	ctx.logger(name).info("dsh-worktree-flow loaded (service + /worktree + /worktree-flow/* + context note + shared docs tools)");
}
