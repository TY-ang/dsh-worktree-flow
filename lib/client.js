                ...
                jsxs("label", {
                  ...
                  children: [
                    ...
                    jsx("textarea", {
                      ...
                      placeholder: "例如：本分支 SQL 放在 backend/sql/selection-v2；修改接口前先阅读共享 docs 快照中的设计说明。"
                    }),
                ...
                preview !== null && Array.isArray(preview.plan) && jsxs("div", {
                  ...
                  children: [
                    ...
                    preview.context?.docs !== undefined && jsxs("div", {
                      style: { fontSize: 12.5, padding: "3px 0", color: preview.context.docs.conflict ? C.error : C.text },
                      children: [
                        jsx("b", { children: "共享 docs" }),
                        jsx("span", { style: { color: C.dim }, children: `  ${preview.context.docs.sourcePath} → ` }),
                        jsx("span", { style: S.mono, children: preview.context.docs.targetPath }),
                        jsx("div", { style: { ...S.faint, color: preview.context.docs.conflict ? C.error : C.faint }, children: preview.context.docs.note })
                      ]
                    }),
                ...
                children: [
                  ...
                  jsxs("div", {
                    ...
                    children: [
                      ...
                      jsx("span", { style: S.faint, children: "可选：新建功能区时复制到功能根内的 .worktree-flow/docs，源目录无需提交 Git。" })
                    ]
                  })
                ]
              }),
