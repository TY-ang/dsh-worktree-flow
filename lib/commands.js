	...
	switch (verb) {
		...
		case "sync": {
			...
			for (const action of result.actions) {
				const label = { registered: "已登记", retitled: "已登记(修正标题)", exists: "已登记", migrated: "清单已迁移", "skip-archived": "已归档跳过", "invalid-manifest": "清单无效（已隔离）", unavailable: "登记不可用" }[action.action] ?? action.action;
